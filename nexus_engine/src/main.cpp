...
int main(int argc, char* argv[]) {
    ...
    std::cout << "Initializing NexusCore C++20 Browser Subsystems:\n"
    ...
    nexus::NexusBrowserEngine engine(1000, 800);
    std::string sample_html = R"(
        <div style="background-color: #0b0f19; padding: 24px; color: #ffffff;">
            <h1 style="color: #38bdf8; font-size: 28px;">Nexus Browser Engine Core</h1>
    ...
    nexus::server::WebServer server(port, "0.0.0.0");
